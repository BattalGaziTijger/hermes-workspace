      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--theme-muted-2)]">
            Operational read of agents, missions and pending items from Hermes.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <>
          <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-6">
            ...
            <StatTile label="out of op." value={summary.non_operational ?? 0} tone={(summary.non_operational ?? 0) > 0 ? 'warn' : 'good'} />
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-[var(--theme-muted)]">
                  No restarts, no WhatsApp, no automatic paid spending.
                </p>
              </div>
